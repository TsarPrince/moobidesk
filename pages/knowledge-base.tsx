          ...
          <div className="flex flex-col justify-around lg:flex-row w-full space-y-12 lg:space-y-0 space-x-0 lg:space-x-8">
            <div className="flex flex-col items-start">
              ...
              <p className="-mt-4 lg:mt-0 pt-6 flex items-center space-x-2">
                ...
                <span>Still need help? <Link href='/request-demo'>Chat to us.</Link></span>
              </p>
            </div>
            ...
            <div className="flex-1 max-w-2xl">
              <form onSubmit={onSubmit} className="flex space-x-4 justify-between">
                ...
                <button
                  onClick={() => onSubmit}
                  className={`bg-purple-600 text-white p-2 pr-4 rounded-xl flex items-center space-x-2 hover:bg-purple-700 focus:ring-4 focus:ring-purple-200 ${loading ? 'cursor-not-allowed opacity-50' : ''}`}
                  disabled={loading}
                >
